...
class ListContrast extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final contrastList = [
      for (int i = 0; i < elevationEntriesList.length; i++)
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              elevationEntries[i].elevation.round().toString(),
              textAlign: TextAlign.center,
...
class RowContrastCompare extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return OutlineButton(
      ...
      child: Row(
        children: <Widget>[
          ContainerWithNumber(index, defaultColor, colorWithContrast.color),
          Expanded(
            child: Column(
...
class ContrastProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final progressBar = FAProgressBar(
      currentValue: getNormalised(contrast),
      size: 10,
